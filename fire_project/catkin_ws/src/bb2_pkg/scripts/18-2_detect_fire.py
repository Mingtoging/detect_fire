...
class DetectFire:
  ...
  def save_picture(self, picture):
    try:
      ...
      filename = '/home/cho/fire_img/fire_{}_{}.png'.format(date, hour)
...
if __name__ == '__main__':
    ...
    try:
        fire_cascade = cv2.CascadeClassifier('/home/cho/catkin_ws/src/bb2_pkg/scripts/cascade025.xml')
        ...
        while not rospy.is_shutdown():
           ...
           if cod1 == True:
            ...
            frame = df.cv_msg
            #gray  = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY) # 안 열어도됨
            ...
            if len(fire) == 0:
              ...
              for (x,y,w,h) in fire:
                  ...
                  if ((fx >= 240)and(fx <= 400)) and ((fy >= 200)and(fy <= 280)):
